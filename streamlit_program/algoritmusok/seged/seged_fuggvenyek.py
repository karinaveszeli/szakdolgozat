import numpy as np
from algoritmusok.seged.sulyok import suly_lada_atlag, suly_lada_expo, suly_lada_reciprok
from algoritmusok.seged.pontszamok import dot_product1, dot_product2, l2_norm_slack
